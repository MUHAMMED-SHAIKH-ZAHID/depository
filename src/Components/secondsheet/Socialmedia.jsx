...
import socialmediawebsite from "../../Images/Socialmedia.png";
  ...
  return (
    <div>
         <div className="md:h-screen  ">
          <div className="md:text-[2rem] font-noto text-3xl  text-center">Social Media</div>
          <div className="grid lg:grid-cols-[3fr,2fr,3fr] md:grid-cols-[2fr,2fr]   pt-10">
           
              <div className=" hidden md:flex   ">
                <div className="flex items-end align ">
                    <img className='h-[6rem] rounded-lg  transform transition-transform duration-300 hover:scale-150  origin-bottom ' src={search} alt="" />
                </div>
                <div className="flex justify-center align-middle pt-5 ">

                <img className="h-[20rem] rounded-2xl transform transition-transform duration-300 hover:scale-125  origin-top-left" src={chatbox} alt="" />
                </div>
              </div>
            ...
            <div className=" md:pt-5   flex justify-center">
               ...
               <img
                  ...
                  alt="website"
                />
                <img className=' z-50 rounded-xl rounded-b-3xl ml-[1rem]  bottom-2 sticky w-[13rem] ' src={socialmediatab} alt="" />
              </div>
              <img
            ...
            <div className=" hidden lg:flex     ">
                ...
                <img className='h-[5rem] mt-15 rounded-xl transform transition-transform duration-300 hover:scale-150  origin-left' src={notification} alt="" />
                </div>
                <div className="flex items-end mb-5 justify-end ">

                <img className="h-[20rem] rounded-2xl transform transition-transform duration-300 hover:scale-125  origin-center" src={profile} alt="" />
                </div>
            </div>
          </div>
         ...
         <div className="standard">Social Media website is an online platform enabling  individuls and communities to connect, share, and interact through user-generated content, fostering communication and networking on a global scale.
